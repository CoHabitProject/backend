...
public class SecurityExceptionHandler {
    ...
    public ResponseEntity<ErrorResDto> handleTokenException(TokenException ex, WebRequest request) {
    ...
    public ResponseEntity<ErrorResDto> handleTechnicalException(TechnicalException ex, WebRequest request) {
        ErrorResDto errorResponseDto = ErrorResDto.builder()
                                                  .status(ex.getCode())
    ...
    public ResponseEntity<ErrorResDto> handleFunctionalException(FunctionalException ex, WebRequest request) {
        ErrorResDto errorResponseDto = ErrorResDto.builder()
    ...
    public ResponseEntity<ErrorResDto> handleInvalidBearerTokenException(InvalidBearerTokenException ex, WebRequest request) {
    ...
    public ResponseEntity<ErrorResDto> handleAccessDeniedException(AccessDeniedException ex, WebRequest request) {
        TokenException tokenException = TokenException.insufficientScope("requested resource");
        return handleTokenException(tokenException, request);
    }
    
    @ExceptionHandler(Exception.class)
    public ResponseEntity<ErrorResDto> handleGenericException(Exception ex, WebRequest request) {
        ErrorResDto errorResponseDto = ErrorResDto.builder()
